...
neofetch
alias opn='xdg-open'
alias cal='/home/beans/.local/cal/cal.sh'
alias biseo='cat /home/beans/.local/cal/biseo'
alias yts='~/.local/bin/ytsearch.sh'
alias w3m='~/.local/bin/ddg.sh'
alias snake='~/.local/bin/snake2.sh'
alias yaz='yazi'
alias f='kitty -e yazi'


alias dimbt='cat /home/beans/.local/cal/nou'
alias bat='batcat --paging=never --style=plain'
source ~/.local/bin/ffm.sh
